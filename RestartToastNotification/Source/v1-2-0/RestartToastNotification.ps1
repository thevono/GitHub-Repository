...
function Write-Log() {
    ...
    param(
        ...
        [string]$Path = "C:\Windows\EndpointApps\RestartToastNotification\RestartToastNotification-Log.log",
        [Parameter(Mandatory=$false)]
...
function Get-GivenName() {
    ...
    try {
        ...
        Write-Log -Level Error -Message "$_" -Action SilentlyContinue
    }
    #>
    <#
